...
object etl_datos_weci_all_date {
  def main(args: Array[String]): Unit = {
    ...
    if (dataDatePart == "2021-05-13") {
      ...
      df_WeciFinal = df_WeciReadXML
        ...
        .selectExpr(
          ...
          "'' as Person_Communication_Phone_Area_Code",
          "'' as Person_Communication_Phone_Formatted_Phone_Number",
          "'' as Person_Communication_Phone_Device_Type",
          "'' as Person_Communication_Phone_Number_With_Country_Code",
          "'' as Person_Communication_Phone_Usage_Type",
      ...
      df_WeciFinal = df_WeciReadXML
        ...
        .selectExpr(
          ...
          //"`ns:Employees`.`ns1:Person_Communication` as Person_Communication_Email",
          "`ns:Employees`.`ns1:Person_Communication`.`ns1:Email`.`ns1:Email_Address` as Person_Communication_Email",
          "'' as Person_Communication_Phone_Area_Code",
          "'' as Person_Communication_Phone_Formatted_Phone_Number",
          "'' as Person_Communication_Phone_Device_Type",
          "'' as Person_Communication_Phone_Number_With_Country_Code",
    ...
    else if (dataDatePart == "2021-05-18") {
      df_WeciFinal = df_WeciReadXML
        .withColumn("natioId", explode_outer(col("`ns:Employees`.`ns1:Person_Identification`.`ns1:National_Identifier`")))
        //.withColumn("relatedPerson", explode_outer(col("`ns:Employees`.`ns1:Related_Person`")))
        //.withColumn("relatedNacionalID", explode_outer(col("`ns:Employees`.`ns1:Related_Person_Identification`")))
    ...
    if (listFolders.length > 0) {
      ...
      for (i <- 1 until listFolders.length) {
        ...
        //20210517130502, 20210517150502, 20210517202102, 20210517173002, 20210517193002
        if (dataDatePart == "2021-05-17" && dataTimeStampPartSplit_for == "20210517130502") {
        ...
        else if (dataDatePart == "2021-05-17" && dataTimeStampPartSplit_for == "20210517150502") {
          df_WeciFinal_All = df_WeciReadXML_All
            .withColumn("natioId", explode_outer(col("`ns:Employees`.`ns1:Person_Identification`.`ns1:National_Identifier`")))
            //.withColumn("relatedPerson", explode_outer(col("`ns:Employees`.`ns1:Related_Person`")))
            //.withColumn("relatedNacionalID", explode_outer(col("`ns:Employees`.`ns1:Related_Person_Identification`")))
        ...
        else if (dataDatePart == "2021-05-17" && dataTimeStampPartSplit_for == "20210517202102") {
          df_WeciFinal_All = df_WeciReadXML_All
            .withColumn("natioId", explode_outer(col("`ns:Employees`.`ns1:Person_Identification`.`ns1:National_Identifier`")))
            //.withColumn("relatedPerson", explode_outer(col("`ns:Employees`.`ns1:Related_Person`")))
            //.withColumn("relatedNacionalID", explode_outer(col("`ns:Employees`.`ns1:Related_Person_Identification`")))
        ...
        else if (dataDatePart == "2021-05-17" && dataTimeStampPartSplit_for == "20210517173002") {
          df_WeciFinal_All = df_WeciReadXML_All
            .withColumn("natioId", explode_outer(col("`ns:Employees`.`ns1:Person_Identification`.`ns1:National_Identifier`")))
            //.withColumn("relatedPerson", explode_outer(col("`ns:Employees`.`ns1:Related_Person`")))
            //.withColumn("relatedNacionalID", explode_outer(col("`ns:Employees`.`ns1:Related_Person_Identification`")))
            ...
            .withColumn("contract", explode_outer(col("`ns:Employees`.`ns1:Employee_Contract`")))
            .withColumn("supervisor", explode_outer(col("`position`.`ns1:Supervisor`")))
            .withColumn("email", explode_outer(col("`ns:Employees`.`ns1:Person_Communication`.`ns1:Email`")))
            .withColumn("phone", explode_outer(col("`ns:Employees`.`ns1:Person_Communication`.`ns1:Phone`")))
            .withColumn("PostalCast", col("`position`.`ns1:Business_Site`.`ns1:Postal_Code`").cast("String"))
            .withColumn("SuperCast", col("`supervisor`.`ns1:ID`").cast("String"))
            .withColumn("IDCast", col("`ns:Employees`.`ns1:Summary`.`ns1:Employee_ID`").cast("String"))
            .withColumn("cast1", col("`compensation`.`ns1:Compensation_Summary_Based_on_Compensation_Grade`.`ns1:Primary_Compensation_Basis`").cast("String"))
            ...
            .withColumn("cast51", col("`supervisor`.`_isAdded`").cast("String"))
            .withColumn("cast52", col("`supervisor`.`_isDeleted`").cast("String"))
            .withColumn("cast53", col("`phone`.`ns1:Area_Code`").cast("String"))
            ...
            .selectExpr(
              ...
              //"`ns:Employees`.`ns1:Person_Communication` as Person_Communication_Email",
              "`email`.`ns1:Email_Address` as Person_Communication_Email",
              "`cast53` as Person_Communication_Phone_Area_Code",
              "`phone`.`ns1:Formatted_Phone_Number` as Person_Communication_Phone_Formatted_Phone_Number",
              "`phone`.`ns1:Phone_Device_Type` as Person_Communication_Phone_Device_Type",
              "`phone`.`ns1:Phone_Number_With_Country_Code` as Person_Communication_Phone_Number_With_Country_Code",
              "`phone`.`ns1:Usage_Type` as Person_Communication_Phone_Usage_Type",
              "`natioId`.`ns1:Country` as National_Identifier_Country",
              // nuevos campos ID
              "'' as National_Identifier_Expiration_Date",
              "'' as National_Identifier_Issued_Date",
        ...
        /*
                        ...
                        else if (dataDatePart == "2021-05-17" && dataTimeStampPartSplit_for == "20210517193002") {
                              df_WeciFinal = df_WeciReadXML
                                //.withColumn("natioId", explode_outer(col("`ns:Employees`.`ns1:Person_Identification`.`ns1:National_Identifier`")))
                                //.withColumn("relatedPerson", explode_outer(col("`ns:Employees`.`ns1:Related_Person`")))
                                //.withColumn("relatedNacionalID", explode_outer(col("`ns:Employees`.`ns1:Related_Person_Identification`")))
                               ...
                               // .withColumn("allowance",col("`compensationPlan`.`ns1:Allowance_Plan`"))
                                ...
                                //.withColumn("other", (col("`ns:Employees`.`ns1:Person_Identification`.`ns1:Other_Identifier`")))
                                //.withColumn("position", (col("`ns:Employees`.`ns1:Position`")))
                                //.withColumn("job_family", explode_outer(col("`position`.`ns1:Job_Family`")))
                                //.withColumn("compensation", explode_outer(col("`ns:Employees`.`ns1:Compensation`")))
                                //.withColumn("relatedOther", explode_outer(col("`relatedNacionalID`.`ns1:Other_Identifier`")))
                                // nuevos mas nuevos withcolumns
                                ...
                                .selectExpr(
                                      ...
                                      "'' as Compensation_Summary_in_Annualized_Frequency_Primary_Total_Base_Pay",
                                      "'' as Compensation_Position_ID",
                                      "'' as Allowance_Plan_Amount",
                                      "'' as Allowance_Plan_Apply_FTE",
                                      "'' as Allowance_Plan_Compensation_Plan",
                                      "'' as Allowance_Plan_Currency",
                                      "'' as Allowance_Plan_End_Date",
                                      "'' as Allowance_Plan_Frequency",
                                      "'' as Allowance_Plan_Start_Date",
                                      "'' as Compensation_Plans_Amount",
                                      "`bonus_plan`.`ns1:Compensation_Plan` as Compensation_Plans_Compensation_Plan",
                                      "`bonus_plan`.`ns1:Currency` as Compensation_Plans_Currency",
                                      // nuevos campos end date en estos 3 arrays
                                      "'' as Compensation_Plans_End_Date",
                                      ...
                                      "'' as Employee_Contract_Contract_ID",
                                      "'' as Employee_Contract_Contract_Status",
                                      "'' as Contract_Type",
                                      "'' as Employee_Contract_Description",
                                      "'' as Employee_Contract_End_Date",
                                      ...
                                      "'' as Employee_Contract_Start_Date",
                                      "`ns:Employees`.`ns1:Entry_Moment` as Entry_Moment",
                                      // MUCHOS CAMPOS NUEVOS CON CASTEOS
                                      "`cast44` as Leave_of_Absence_Age_of_Dependent",
                                      "`ns:Employees`.`ns1:Leave_of_Absence`.`ns1:Child_Birth_Date` as Leave_of_Absence_Child_Birth_Date",
                                      ...
                                      "'' as Person_Communication_Phone_Number_With_Country_Code",
                                      "'' as Person_Communication_Phone_Usage_Type",
                                      "'' as National_Identifier_Country",
                                      // nuevos campos ID
                                      "'' as National_Identifier_Expiration_Date",
                                      "'' as National_Identifier_Issued_Date",
                                      // fin campos ID
                                      ...
                                      // nuevos campos Bussines_Site
                                      "'' as Business_Site_Country_Region",
                                      // fin nuevos campos
                                      "'' as Business_Site_Location_ID",
                                      "'' as Business_Site_Location_Name",
                                      "'' as Business_Site_Postal_Code",
                                      // nuevos campos Bussines_Site
                                      "'' as Business_Site_State_Province",
                                      // fin nuevos campos
                                      ...
                                      "'' as Position_Management_Level",
                                      "'' as Position_Position_ID",
                                      "'' as Position_Time_Type",
                                      "'' as Supervisor_isAdded",
                                      "'' as Supervisor_isDeleted",
                                      "'' as Supervisor_ID",
                                      "'' as Supervisor_Name",
