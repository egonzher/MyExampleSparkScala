  ...
  def main(args: Array[String]): Unit = {
    ...
    val df_WeciFinal = df_WeciReadXML
      ...
      .selectExpr(
          ...
          "`relatedNacionalID`.`ns1:National_Identifier`.`ns1:National_ID_Type` as relatedNacionalID_National_ID_Type",
          "`relatedNacionalID`.`ns1:National_Identifier`.`ns1:National_ID` as relatedNacionalID_National_ID",
