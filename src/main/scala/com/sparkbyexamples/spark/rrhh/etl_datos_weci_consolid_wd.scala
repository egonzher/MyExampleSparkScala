...
/*
 |    |-- ns1:Worker_Status: struct (nullable = true)
 |    |    |-- ns1:Active: boolean (nullable = true)
 |    |    |-- ns1:Active_Status_Date: string (nullable = true)
 |    |    |-- ns1:Continuous_Service_Date: string (nullable = true)
 |    |    |-- ns1:First_Day_of_Work: string (nullable = true)
 |    |    |-- ns1:Hire_Date: string (nullable = true)
 |    |    |-- ns1:Is_Rehire: boolean (nullable = true)
 |    |    |-- ns1:Not_Returning: long (nullable = true)
 |    |    |-- ns1:Original_Hire_Date: string (nullable = true)
 |    |    |-- ns1:Regrettable_Termination: long (nullable = true)
 |    |    |-- ns1:Return_Unknown: long (nullable = true)
 |    |    |-- ns1:Secondary_Termination_Reason: string (nullable = true)
 |    |    |-- ns1:Seniority_Date: string (nullable = true)
 |    |    |-- ns1:Status: string (nullable = true)
 |    |    |-- ns1:Terminated: boolean (nullable = true)
 */
