...
object etl_datos_weci_all_date_elseif {
  def main(args: Array[String]): Unit = {
    ...
    //Solo funciona para estos ultimos
    ...
    if (dataDatePart == "2021-05-13-05-02") {
    ...
    else if (dataDatePart == "2021-05-15-05-02") {
      df_WeciFinal = df_WeciReadXML
        .withColumn("natioId", explode_outer(col("`ns:Employees`.`ns1:Person_Identification`.`ns1:National_Identifier`")))
        //.withColumn("relatedPerson", explode_outer(col("`ns:Employees`.`ns1:Related_Person`")))
        //.withColumn("relatedNacionalID", explode_outer(col("`ns:Employees`.`ns1:Related_Person_Identification`")))
    ...
    else if (dataDatePart == "2021-05-17-13-05") {
    ...
    else if (dataDatePart == "2021-05-17-15-05") {
      df_WeciFinal = df_WeciReadXML
        .withColumn("natioId", explode_outer(col("`ns:Employees`.`ns1:Person_Identification`.`ns1:National_Identifier`")))
        //.withColumn("relatedPerson", explode_outer(col("`ns:Employees`.`ns1:Related_Person`")))
        //.withColumn("relatedNacionalID", explode_outer(col("`ns:Employees`.`ns1:Related_Person_Identification`")))
    ...
    else if (dataDatePart == "2021-05-17-17-30") {
      df_WeciFinal = df_WeciReadXML
        .withColumn("natioId", explode_outer(col("`ns:Employees`.`ns1:Person_Identification`.`ns1:National_Identifier`")))
        //.withColumn("relatedPerson", explode_outer(col("`ns:Employees`.`ns1:Related_Person`")))
        //.withColumn("relatedNacionalID", explode_outer(col("`ns:Employees`.`ns1:Related_Person_Identification`")))
    ...
    else if (dataDatePart == "2021-05-17-20-21") {
      df_WeciFinal = df_WeciReadXML
        .withColumn("natioId", explode_outer(col("`ns:Employees`.`ns1:Person_Identification`.`ns1:National_Identifier`")))
        //.withColumn("relatedPerson", explode_outer(col("`ns:Employees`.`ns1:Related_Person`")))
        //.withColumn("relatedNacionalID", explode_outer(col("`ns:Employees`.`ns1:Related_Person_Identification`")))
    ...
    else if (dataDatePart == "2021-05-18-09-30") {
      df_WeciFinal = df_WeciReadXML
        //.withColumn("natioId", explode_outer(col("`ns:Employees`.`ns1:Person_Identification`.`ns1:National_Identifier`")))
        //.withColumn("relatedPerson", explode_outer(col("`ns:Employees`.`ns1:Related_Person`")))
        //.withColumn("relatedNacionalID", explode_outer(col("`ns:Employees`.`ns1:Related_Person_Identification`")))
        ...
        .selectExpr(
          ...
          "`phone`.`ns1:Phone_Number_With_Country_Code` as Person_Communication_Phone_Number_With_Country_Code",
          "`phone`.`ns1:Usage_Type` as Person_Communication_Phone_Usage_Type",
          //Campos nuevos , esta vez en telefono
    ...
    else if (dataDatePart == "2021-05-18-13-19") {
        df_WeciFinal = df_WeciReadXML
          //.withColumn("natioId", explode_outer(col("`ns:Employees`.`ns1:Person_Identification`.`ns1:National_Identifier`")))
          //.withColumn("relatedPerson", explode_outer(col("`ns:Employees`.`ns1:Related_Person`")))
          //.withColumn("relatedNacionalID", explode_outer(col("`ns:Employees`.`ns1:Related_Person_Identification`")))
